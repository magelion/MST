...
/**
*Classe en grande partie inspir√©e du code fourni (ColorSensor MarvinPersycup)
*/
public class Couleur {
    ...
    /*Erreur mise ‡ 0.02 afin d'assurer la reconnaissance 
    d'une ligne mÍme si le robot n'est pas complËtement dessus
    */
	...
	/**
	 * Tableau contenant l'indice de la couleur ainsi qu'un √©chantillon des valeurs couleurs r√©cup√©r√©s
	 */
	...
	/**
	 * repr√©snte les donn√©es fournit par le capteur de couleur sous forme standard
	 */
	private final SampleProvider	average;
	
	/**
	 * Cr√©er une nouvelle instance du capteur de couleur et initialize le SampleProvider 
	 * et charge le fichier de configuration
	 * @param option: si ==0, calibrage d'apr√®s fichier configuration
	...
	/*renvoie un Èchantillon correspondant ‡ la couleur que l'on veut calibrer*/
	...
	/*Calibre les couleurs trois fois et retient la loyenne des Èchantillons*/
	...
	/**
	 * Renvoie la couleur connue la plus proche de l'Èchantillon.
	 * 
	 ...
	 * @param color un entier associ√© √† une couleur
	 * @return Color.COLOR la couleur associ√© √† l'entier en entr√©e
	 */
	...
	/**
	 * Calcule la distance entre deux couleurs.la mÈthode get>la mÈhtttttttt
